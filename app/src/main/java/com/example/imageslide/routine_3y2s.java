...
public class routine_3y2s extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Tool Bar
        drawerLayout = (DrawerLayout) findViewById(R.id.drawerLayout_r3y2sID);
        navigationView = (NavigationView) findViewById(R.id.navigatio_r3y2sID);
        toolbar = (androidx.appcompat.widget.Toolbar) findViewById(R.id.toolBar_r3y2sID);
